...
const styles = {
    sideBarIcon: 'relative flex items-center justify-center h-12 w-12 m-0 text-purple-100 bg-gray-800 rounded-3xl transition-all duration-200 ease-linear cursor-pointer',
