...
import {greninjaCounters} from './terraRaidEventCounters';
...
<div className={'flex flex-row space-x-2'}>
    {greninjaCounters.map(({id, name, type, ability, terraType, nature, heldItem, role, moves, otherMoves, evs, notes }) => (
        <PokemonBuildModal 
            id={id}
            name={name} 
            type={type}
