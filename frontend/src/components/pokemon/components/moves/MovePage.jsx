const InfoRow = ({ title, info, ability, type }) => (
  <div className="row-flex justify-between">
    <div className={"m-1"}>
      ...
      <div className={"xxs-label phone:label border-2 border-gray-800"}>
        {title}:
      </div>
    </div>
    {ability ? (
...
export default function MovePage({ move }) {
  return (
    <div className={"flex justify-center"}>
      <div
        className={
          "m-2 bg-gray-700 rounded-lg border border-purple-100 w-5/6 tablet:w-full text-xxs phone:text-xs"
        }
      >
